...
def main():
    ...
    if "--register" in sys.argv or "--unregister" in sys.argv:
        ...
        if "--prueba" in sys.argv:
            ...
            obs_generales = "Cumlaudae CumlaudaeCumlaudaeCumlaudaeCumlaudaeCumlaudaeCumlaudaeCumlaudaeCumlaudae Observaciones Generales<br/>linea2<br/>linea3"
            ...
            fepdf.AgregarDato("custom-apellido_cliente", "Pepe")
            fepdf.AgregarDato("custom-calif_profesional", "calificacion")
            fepdf.AgregarDato("custom-seccion", "nose")
            fepdf.AgregarDato("custom-tipo_liqui", "nose")
            fepdf.AgregarDato("custom-fecha_depo", "fecha")
            fepdf.AgregarDato("custom-periodo_depo", "periodo")
            fepdf.AgregarDato("custom-banco", "banco")
            fepdf.AgregarDato("custom-fecha_reintegro", "fecha")
            fepdf.AgregarDato("custom-sueldo", "12345")
            fepdf.AgregarDato("custom-cant", "cantidad")
            fepdf.AgregarDato("custom-rem_extentas", "nose")
            fepdf.AgregarDato("custom-descuentos", "12345")
